...
CREATE TABLE `ENTITY` (
	`id`	INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT UNIQUE,
	`metadata`	TEXT,
	`parent`	TEXT NOT NULL DEFAULT 1,
	`ADVENTURE`	INTEGER,
	`ENTITY`	INTEGER,
	`ARMOR`	INTEGER,
	`BACKGROUND`	INTEGER,
	...
	`WEAPONS`	INTEGER,
	FOREIGN KEY(`BACKGROUND`) REFERENCES `BACKGROUND`(`id`) ON DELETE CASCADE,
	...
	FOREIGN KEY(`ADVENTURE`) REFERENCES `ADVENTURE`(`id`) ON DELETE CASCADE,

...
public class KeyValuePairAdapter extends CustomListAdapter<KeyValuePair> {
    public KeyValuePairAdapter(LayoutInflater inflater) {
        super(inflater);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        KeyValuePairCell cell = new KeyValuePairCell(inflater, convertView, parent);

...
import com.soupthatisthick.encounterbuilder.view.cell.detail.ContactDetailCell;
...
public class ExContactsAdapter extends CustomToggleAdapter<Contact> {
    public ExContactsAdapter(LayoutInflater inflater) {
        super(inflater);
    }

    @Override
    public View getCollapsedView(int position, View convertView, ViewGroup parent) {
        // Currently, the amount of information about a contact is minimal, so show the detailed view
    ...
    public View getExpandedView(int position, View convertView, ViewGroup parent) {
        ContactDetailCell cell = new ContactDetailCell(inflater, convertView, parent);

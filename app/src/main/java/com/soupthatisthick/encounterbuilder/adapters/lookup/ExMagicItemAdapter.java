...
public class ExMagicItemAdapter extends CustomToggleAdapter<MagicItem> {
    public ExMagicItemAdapter(LayoutInflater inflater) {
        super(inflater);
    }

    @Override
    public View getCollapsedView(int position, View convertView, ViewGroup parent) {
        MagicItemSummaryCell cell = new MagicItemSummaryCell(inflater, convertView, parent);

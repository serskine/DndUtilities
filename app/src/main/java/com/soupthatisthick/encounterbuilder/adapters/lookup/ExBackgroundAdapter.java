...
public class ExBackgroundAdapter extends CustomToggleAdapter<Background> {
    public ExBackgroundAdapter(LayoutInflater inflater) {
        super(inflater);
    }

    @Override
    public View getCollapsedView(int position, View convertView, ViewGroup parent) {
        BackgroundSummaryCell cell = new BackgroundSummaryCell(inflater, convertView, parent);
    ...
    public View getExpandedView(int position, View convertView, ViewGroup parent) {
        BackgroundDetailCell cell = new BackgroundDetailCell(inflater, convertView, parent);
        cell.updateUi(getCastedItem(position));
        return cell.getView();
    }

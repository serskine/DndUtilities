...
public class ExSpellAdapter extends CustomToggleAdapter<Spell> {
    public ExSpellAdapter(LayoutInflater inflater) {
        super(inflater);
    }

    @Override
    public View getCollapsedView(int position, View convertView, ViewGroup parent) {
        SpellSummaryCell cell = new SpellSummaryCell(inflater, convertView, parent);

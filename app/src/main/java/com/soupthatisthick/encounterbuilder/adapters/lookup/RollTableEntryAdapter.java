...
public class RollTableEntryAdapter extends CustomToggleAdapter<RollTableEntry> {
    public RollTableEntryAdapter(LayoutInflater inflater) {
        super(inflater);
    }

    @Override
    public View getCollapsedView(int position, View convertView, ViewGroup parent) {
        RollTableEntryCell cell = new RollTableEntryCell(inflater, convertView, parent);
    ...
    public View getExpandedView(int position, View convertView, ViewGroup parent) {
        return  getCollapsedView(position, convertView, parent);
    }

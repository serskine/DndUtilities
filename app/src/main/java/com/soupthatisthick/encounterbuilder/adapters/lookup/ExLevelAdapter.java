...
public class ExLevelAdapter extends CustomToggleAdapter<Level> {

    public ExLevelAdapter(LayoutInflater inflater) {
        super(inflater);
    }

    @Override
    public View getCollapsedView(int position, View convertView, ViewGroup parent) {
        LevelSummaryCell cell = new LevelSummaryCell(inflater, convertView, parent);

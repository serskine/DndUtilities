...
public class ExStandardMonsterAdapter extends CustomToggleAdapter<StandardMonster> {
    public ExStandardMonsterAdapter(LayoutInflater inflater) {
        super(inflater);
    }

    @Override
    public View getCollapsedView(int position, View convertView, ViewGroup parent) {
        StandardMonsterSummaryCell cell = new StandardMonsterSummaryCell(inflater, convertView, parent);

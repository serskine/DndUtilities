...
public class TextAdapter extends CustomListAdapter<String>
{
    public TextAdapter(LayoutInflater inflater) {
        super(inflater);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        TextCell cell = new TextCell(inflater, convertView, parent);

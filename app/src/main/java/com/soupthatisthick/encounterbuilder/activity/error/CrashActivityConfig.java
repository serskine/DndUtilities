 ...
 */
public class CrashActivityConfig implements Serializable {
        ...
        private CrashApp.EventListener eventListener = null;
        ...
        @Nullable
        public CrashApp.EventListener getEventListener() {
            return eventListener;
        }

        public void setEventListener(@Nullable CrashApp.EventListener eventListener) {
            this.eventListener = eventListener;
        }

        public static class Builder {
            private CrashActivityConfig config;

            @NonNull
            public static Builder create() {
                Builder builder = new Builder();
                CrashActivityConfig currentConfig = CrashApp.getConfig();

                CrashActivityConfig config = new CrashActivityConfig();
            ...
            /**
             * Defines if CrashApp crash interception mechanism is enabled.
             * Set it to true if you want CrashApp to intercept crashes,
             ...
             */
            @NonNull
            public Builder eventListener(@Nullable CrashApp.EventListener eventListener) {
            ...
            @NonNull
            public CrashActivityConfig get() {
                return config;
            }

            public void apply() {
                CrashApp.setConfig(config);
            }
        }
